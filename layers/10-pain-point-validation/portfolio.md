...
|------|--------|-----------|----------|-------|
| `cross-subject-eeg` | admitted | `tracks/cross-subject-eeg/` | 2026-05-02 | First admission under v2 rubric. Critic `pass-with-fixes` (citation fix applied). Pre-reg required at layer-20 protocol-lock. |
