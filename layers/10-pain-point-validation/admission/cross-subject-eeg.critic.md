...
- Read layers/10-pain-point-validation/README.md v2 admission rubric: ≥2 independent sources, constituency reachable in principle, pain statement matches evidence, no invented pain, quote accuracy.
