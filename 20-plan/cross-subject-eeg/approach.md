...
`30-implement/README.md` read end-to-end. `30-implement/shared/data/`, `30-implement/shared/eval/`,
`30-implement/shared/models/` do not exist. `shared/` contains only its root README.
...
`30-implement/cross-subject-eeg/code/` and promoted to `shared/`
once ≥1 plausible second consumer exists. Plausible second consumers are
noted for each; they satisfy the 30-implement/README.md promotion rule.

**1. `30-implement/shared/eval/leakage_audit.py`**
...
**2. `30-implement/shared/eval/fewshot_curve.py`**
...
**4. `30-implement/shared/models/riemannian_baseline.py`**
