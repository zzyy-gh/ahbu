...
- **Wearable stress-detection vendors and quantified-self users** (WESAD-style). Feel inter-individual variability — well-documented person-specific vs generic gap across Schmidt 2018 + follow-ups (e.g., Li 2024 cited via PMC12685819: ~95 % person-specific vs ~67 % generic). Practitioners cope by per-user calibration.
...
- WESAD: Schmidt et al. 2018 baseline 93.1 % LDA. Follow-up work documents a substantial person-specific vs generic gap on stress detection — PMC12685819 cites Li et al. 2024 reporting person-specific ~95.06 % vs generic ~67 % using their cross-domain framework. The previously-cited "98.9 % vs 83.9 %" specific figures were not located in PMC12685819 in spot-check (real-pain-critic 2026-05-02, major finding); they may exist in Schmidt 2018 or arXiv:2203.09663 (binary PDFs not parsed in this pass) but are removed here pending source confirmation. The qualitative finding stands: substantial person-specific vs generic accuracy gap is well-documented across multiple WESAD follow-ups. [WESAD paper](https://www.eti.uni-siegen.de/ubicomp/papers/ubi_icmi2018.pdf), [PMC12685819](https://pmc.ncbi.nlm.nih.gov/articles/PMC12685819/), [arXiv:2203.09663](https://arxiv.org/pdf/2203.09663).
...
- "Reproducible Physiological Features in Affective Computing: A Preliminary Analysis on Arousal Modeling" 2025. Out of **164 features tested across cardiac and electrodermal signals combined**, only **2 electrodermal-derived features** showed reproducible, statistically significant association with arousal across studies. [arXiv:2508.10561](https://arxiv.org/html/2508.10561). Near-total failure of feature stability across the full mixed-modality feature pool.
...
- Emotion-elicitation validity: DEAP labels ARE participant self-reports — 32 volunteers rated each video clip on valence / arousal / dominance / liking on a 1–9 scale post-stimulus. The label-validity critique is real but lives elsewhere: retrospective self-report under controlled lab induction, post-hoc binarization with arbitrary cutoffs that vary across papers, ecological validity of induced affect vs in-the-wild affect. [Evaluation in EEG Emotion Recognition arXiv:2505.18175](https://arxiv.org/html/2505.18175v1) — *Note: an earlier draft of this candidate stated DEAP labels were "stimulus-class labels, not participant-reported." That was a factual inversion (real-pain-critic 2026-05-02, critical finding); corrected here.*
